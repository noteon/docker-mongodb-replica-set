...
mongo --eval 'var rst=rs.initiate();sleep(5000); printjson(rst); rs.add(rst.me.replace("27017","27018"));sleep(1000);rs.add(rst.me.replace("27017","27019"));sleep(1000); printjson(rs.status());'
